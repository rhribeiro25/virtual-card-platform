package br.com.rhribeiro25.virtual_card_platform.infrastructure.adapter.in.rest;

import br.com.rhribeiro25.virtual_card_platform.application.dto.*;
import br.com.rhribeiro25.virtual_card_platform.application.port.in.InputCardMapper;
import br.com.rhribeiro25.virtual_card_platform.application.port.out.OutputCardMapper;
...
public class CardController {
    ...
    public ResponseEntity<CardResponse> createCard(@Valid @RequestBody CardRequest request) {
        Card card = cardUsecase.create(InputCardMapper.toEntity(request));
        return ResponseEntity.status(HttpStatus.CREATED).body(OutputCardMapper.toResponse(card));
    }
    ...
    public ResponseEntity<?> spend(@PathVariable UUID id, @Valid @RequestBody TransactionRequest request) {
        ...
        return ResponseEntity.ok(OutputCardMapper.toResponse(card));
    }
    ...
    public ResponseEntity<Page<TransactionResponse>> getTransactions(
        ...
        Page<TransactionResponse> responsePage = transactionsPage.map(OutputTransactionMapper::toResponse);
