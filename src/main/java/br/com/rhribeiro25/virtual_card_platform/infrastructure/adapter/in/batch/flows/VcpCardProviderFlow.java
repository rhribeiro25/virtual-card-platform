...
public class VcpCardProviderFlow {

    @Bean
    public Flow cardProviderFlow(
            Step cardProviderStep
    ) {
        return new FlowBuilder<Flow>(SpringBatchFlow.CARD_PROVIDER)
                .start(cardProviderStep)
                .build();
    }
